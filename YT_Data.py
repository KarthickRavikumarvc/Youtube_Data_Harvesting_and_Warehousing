...
atlas_username = 'karthick'
atlas_password = 'karthick'
atlas_cluster = 'youtubecluster'
client = MongoClient(
    f"mongodb+srv://{atlas_username}:{atlas_password}@{atlas_cluster}.scrgc79.mongodb.net/?retryWrites=true&w=majority")
# mongodb+srv://karthick:<password>@youtubecluster.scrgc79.mongodb.net/?retryWrites=true&w=majority

db = client['youtube_data']
collection = db['channel_data']

# api_key
Api_key = 'AIzaSyC5lTSR-30wlBETyFf_rRko_KawjP1kFIE'
